grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"n"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smen1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"a"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smea1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"adv"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smeadv1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"v"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smev1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"cc"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smecc1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"cs"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smecs1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"num"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smenum1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"indef"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smeindef1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"pers"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smepers1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"pcle"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smepcle1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"po"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smepo1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"pr"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smepr1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"interr"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smeinterr1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"refl"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smerefl1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f1 | grep '"dem"' | tr "<" ">" | cut -d ">" -f7 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smedem1
...
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"n"' | cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/sman1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"a"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smaa1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"adv"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smaadv1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"v"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smav1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"cc"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smacc1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"cs"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smacs1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"num"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smanum1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"indef"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smaindef1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"pers"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smapers1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"pcle"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smapcle1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"po"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smapo1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"pr"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smapr1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"interr"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smainterr1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"refl"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smarefl1
grep '<r>' $HOME/apertium/apertium-sme-sma/apertium-sme-sma.sme-sma.dix | sed 's/<r>/¢/' | cut -d "¢" -f2 | grep -v "<b" | grep '"dem"' |  cut -d "<" -f1 | sort -u > $HOME/apertium/apertium-sme-sma/dev/smadem1
